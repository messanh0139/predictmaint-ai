...
C-MAPSS contient plusieurs lignes successives pour un même moteur. Un split aléatoire par ligne peut placer les premiers cycles d'un moteur dans le train et ses cycles ultérieurs dans la validation. Le modèle bénéficie alors indirectement de la trajectoire du même équipement.
...
- 100 moteurs du `test_FD001` conservés comme holdout externe NASA.
...
- TEST NASA : preuve finale externe ; jamais dans le retraining automatique.
