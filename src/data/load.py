...
def load_train_fd001(raw_dir: Path = RAW_DIR) -> pd.DataFrame:
    """Charge uniquement le train NASA utilisé pour le développement.
...
def load_test_inputs_fd001(raw_dir: Path = RAW_DIR) -> pd.DataFrame:
    """Charge seulement les entrées du test NASA, sans vérité terrain."""
...
def load_external_test_fd001(
    ...
    """Charge le holdout NASA et sa vérité terrain.
